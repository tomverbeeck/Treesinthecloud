...
public class WelcomeScreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layouts = new int[]{
                R.layout.layout_welcome_slide_1,
                R.layout.layout_welcome_slide_2,
                R.layout.layout_welcome_slide_3};
        ...
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    Toast.makeText(getApplicationContext(), "db size is " + db.getTreesCount(), Toast.LENGTH_SHORT).show();
